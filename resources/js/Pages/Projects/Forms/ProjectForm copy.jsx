...
import ChatWithGPT from '@/Components/Scripts/ChatWithGPT';
...
//     try {
//         const res = await axios.post(route('chat.gpt'), { message: prompt });
//         console.log("Raw API Response:", res.data); // Log the raw response

//         // Check if 'choices' exist in the response
//         if (res.data && res.data.choices && res.data.choices.length > 0) {
//             const textResponse = res.data.choices[0].message.content;
