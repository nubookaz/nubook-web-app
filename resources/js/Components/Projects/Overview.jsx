...
export default function Overview({
    ...
    const distributedProjects = props.projects.filter(project => project.project_stage === 'Distribution');
            ...
            <div className={` ${isPortrait ? 'w-full h-full my-[2rem]' : 'w-1/2'  } `}>
                <div className={`grid grid-row-3 h-full border-slate-50 ${isPortrait ? 'w-full border--2 ' : 'border-l-2 '}`}>
                    <div className='grid grid-cols-2 w-full border-slate-50  border-b-2'>
                        <div className='flex bgColor border-r-2 border-slate-50'>
                    ...
                    <div className='flex bgColor'>
                            <div className='m-auto'>
                                <span className='text-2xl font-bold'>{distributedProjects.length}</span>
