...
export default function ProductionDate({ data }){
    ...
    return(
        ...
        <CardContainer className="" header="Production Date" showButtonIcon={true} >
            <div className="flex flex-col gap-4">
                ...
                <div className='bg-slate-50 p-6 rounded-2xl secondary-color h-full min-h-[9.5rem]'>
